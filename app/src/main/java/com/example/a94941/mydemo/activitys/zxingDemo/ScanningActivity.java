...
import com.example.a94941.mydemo.activitys.zxingDemo.scanning.CameraManager;
import com.example.a94941.mydemo.activitys.zxingDemo.scanning.CaptureActivityHandler;
import com.example.a94941.mydemo.activitys.zxingDemo.scanning.InactivityTimer;
import com.example.a94941.mydemo.activitys.zxingDemo.scanning.RGBLuminanceSource;
import com.example.a94941.mydemo.activitys.zxingDemo.scanning.ViewfinderView;
 ...
 * @描述 ${TODO}
 */
public class ScanningActivity extends BaseToolbarActivity implements Callback, View.OnClickListener {
    ...
    protected void initViewsAndEvents() {
        mTvTitle.setText(R.string.saoyisao);
        initView();
        setListener();
    }
    ...
    private void initView() {
        ...
        result_bitmap_iv = findViewById(R.id.result_bitmap_iv);
        hasSurface = false;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PARSE_BARCODE_FAIL:
                    ToastUtils.showToast("我的：" + (String) msg.obj);
                    break;
            }
        }
    };
