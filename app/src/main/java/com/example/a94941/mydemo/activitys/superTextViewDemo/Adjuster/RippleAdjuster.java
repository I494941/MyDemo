...
package com.example.a94941.mydemo.activitys.superTextViewDemo.Adjuster;
...
import com.example.a94941.mydemo.activitys.superTextViewDemo.SuperTextView;
...
public class RippleAdjuster extends SuperTextView.Adjuster {
    ...
    public boolean onTouch(SuperTextView v, MotionEvent event) {
        ...
        LogUtils.e("onTouch", "action = " + action);
        switch (action) {
