    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.divide_btn:
                ...
                break;
            case R.id.equal_btn:
                String res = mResultText.getText().toString();
                if (!res.contains("=")) {
                    existedText = mResultText.getText() + "=" + getResult();
                    isCounted = true;
                }
                break;
            /**
            ...
            case R.id.ac_btn:
//                existedText = "0";
                Intent intent = new Intent(CalculatorActivity.this,MyCalculatorActivity.class);
